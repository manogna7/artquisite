...
jQuery(document).ready(function(){
	...
	function waxon_tm_modalbox_blog(){

		var modalBox	= jQuery('.waxon_tm_modalbox_blog');
		var list 		= jQuery('.waxon_tm_blog ul li');
	...
	function waxon_tm_popupscroll(){
		...
		var WW				= jQuery(window).width();
		var H				= jQuery(window).height();
		var scrollable		= jQuery('.waxon_tm_modalbox_blog .scrollable');

		var popupBox		= jQuery('.waxon_tm_modalbox_blog .description_wrap');
	...
	function waxon_tm_filter_opener(){
		...
		var button	= jQuery('.waxon_tm_portoflio .gallery_filter .wrapper a');
		var list	= jQuery('.waxon_tm_portoflio .gallery_filter ul li');
	...
	function waxon_tm_gallery(){

		if(jQuery().isotope) {

			// Needed variables
			var list 		 = jQuery('.waxon_tm_portoflio .gallery_inner ul');
			var filter		 = jQuery('.waxon_tm_portoflio .gallery_filter ul');
