        ...
        if (this.history.initialized && this.params.history.enabled) {
          ...
          (r && r.value === a) ||
            (this.params.history.replaceState
              ...
              : t.history.pushState({ value: a }, null));
        }
      },
      slugify: function (e) {
        return e
        ...
        ? b.ishwscroll && f.hastransition && b.opt.usetransition
          ? ((this.prepareTransition = function (c, e) {
            ...
            (this.doScrollLeft = function (c, f) {
              var g = b.scrollrunning ? b.blogcrolly : b.getScrollTop();
              b.doScrollPos(c, g, f);
            }),
            (this.doScrollTop = function (c, f) {
              var g = b.scrollrunning ? b.blogcrollx : b.getScrollLeft();
              b.doScrollPos(g, c, f);
            }),
            (this.doScrollPos = function (c, e, g) {
              var h = b.getScrollTop(),
                l = b.getScrollLeft();
              (0 > (b.blogcrolly - h) * (e - h) ||
                0 > (b.blogcrollx - l) * (c - l)) &&
                b.cancelScroll();
              !1 == b.opt.bouncescroll &&
                (0 > e ? (e = 0) : e > b.page.maxh && (e = b.page.maxh),
                0 > c ? (c = 0) : c > b.page.maxw && (c = b.page.maxw));
              if (b.scrollrunning && c == b.blogcrollx && e == b.blogcrolly)
                return !1;
              b.blogcrolly = e;
              b.blogcrollx = c;
              b.blogcrollspeed = g || !1;
              if (b.timer) return !1;
              b.timer = setTimeout(function () {
                ...
                l =
                  b.blogcrollspeed && 1 < b.blogcrollspeed
                    ? b.blogcrollspeed
                ...
                0 < l &&
                  (!b.scrollrunning &&
                    ...
                    b.onscrollstart.call(b, {
                      ...
                      current: { x: h, y: g },
                      request: { x: c, y: e },
                      end: { x: b.blogcrollx, y: b.blogcrolly },
                      speed: l,
                    }),
                  f.transitionend
                    ? b.scrollendtrapped ||
                  ...
                  (b.timerscroll = {
                    bz: new BezierClass(g, b.blogcrolly, l, 0, 0, 0.58, 1),
                    bh: new BezierClass(h, b.blogcrollx, l, 0, 0, 0.58, 1),
                  }),
                  b.cursorfreezed ||
                ...
                b.synched("doScroll-set", function () {
                  ...
                  b.setScrollTop(b.blogcrolly);
                  b.setScrollLeft(b.blogcrollx);
            ...
            (this.onScrollEnd = function () {
              ...
              if (c != b.blogcrolly || e != b.blogcrollx)
          ...
          : ((this.doScrollLeft = function (c, f) {
            ...
            (this.doScrollPos = function (c, f, g) {
              ...
              if (b.timer && b.blogcrolly == f && b.blogcrollx == c) return !0;
              b.timer && w(b.timer);
              b.timer = 0;
              var h = b.getScrollTop(),
                l = b.getScrollLeft();
              (0 > (b.blogcrolly - h) * (f - h) ||
                0 > (b.blogcrollx - l) * (c - l)) &&
                b.cancelScroll();
              b.blogcrolly = f;
              b.blogcrollx = c;
              if (!b.bouncescroll || !b.rail.visibility)
                0 > b.blogcrolly
                  ? (b.blogcrolly = 0)
                  : b.blogcrolly > b.page.maxh && (b.blogcrolly = b.page.maxh);
              if (!b.bouncescroll || !b.railh.visibility)
                0 > b.blogcrollx
                  ? (b.blogcrollx = 0)
                  : b.blogcrollx > b.page.maxw && (b.blogcrollx = b.page.maxw);
              b.dst = {};
              b.dst.x = c - l;
              b.dst.y = f - h;
              b.dst.px = l;
      ...
      this.doScrollBy = function (c, f) {
        var g = 0,
          g = f
            ...
            : (b.timer ? b.blogcrolly : b.getScrollTop(!0)) - c;
        if (b.bouncescroll) {
      ...
      this.doScrollLeftBy = function (c, f) {
        var g = 0,
          g = f
            ...
            : (b.timer ? b.blogcrollx : b.getScrollLeft(!0)) - c;
        if (b.bouncescroll) {
...
function initMap() {
  var map = new google.maps.Map(document.getElementById("ieatmaps"), {
    center: { lat:17.418704862076165
      , lng: 78.4450877331777 
    },
    zoom: 10,
    styles: [
      {
  ...
  var marker = new google.maps.Marker({
    position: new google.maps.LatLng(17.418704862076165, 78.4450877331777
      ),
    title: "ASL",
    map: map,
  });
